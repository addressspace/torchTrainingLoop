...
def trainingLoop(model, train_loader, num_epochs, criterion, optimizer, validation_loader = None, lr_decay_factor = False, modelSave = True, homeDir = False, resume=False, device='cpu', visualization=True):
	if 	visualization:
		# Initialize figure
